  ...
  return (
    <div className="w-full bg-[#FAFCFF] min-h-[calc(100vh-140px)] py-8 px-4 sm:px-6 lg:px-8" id="hotspots-screen">
      <div className="max-w-7xl mx-auto space-y-8">
          ...
          <div>
            ...
            <div className="flex items-center gap-3">
              <h1 className="text-2xl sm:text-3xl font-extrabold text-[#0B1E38] tracking-tight">
                Nagpur Snapchat-Style Live Photo Hotspot Map
              </h1>
              <span className="px-2.5 py-1 bg-red-600 text-white rounded-full text-xs font-black shrink-0 animate-pulse">
                Live Geotagged Snaps
              </span>
            </div>
            <p className="text-xs sm:text-sm text-slate-600 mt-1 max-w-3xl">
              World/city spatial aerial map with live geotagged photo bubbles, waterlogging metrics, streetlight outage rings, and dedicated real-time problem-solving AI for each civic objective.
            </p>
          </div>
        ...
        {/* Snapchat World Photo Map Component */}
        <div className="space-y-3">
          <div className="flex items-center justify-between">
            <h2 className="text-lg font-bold text-[#0B1E38] flex items-center gap-2">
              <Camera className="w-5 h-5 text-amber-500" />
              <span>Snapchat-Style World Map with Photo Stories</span>
            </h2>
