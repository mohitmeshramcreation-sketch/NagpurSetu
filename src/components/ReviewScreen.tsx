...
export const ReviewScreen: React.FC<ReviewScreenProps> = ({
  ...
  const handleReportProblem = () => {
    ...
    const newId = `REQ-2024-${Math.floor(100 + Math.random() * 900)}`;
          ...
          <div className="bg-[#EEF3F8] border border-slate-200/90 rounded-2xl p-6 sm:p-8 space-y-6 shadow-xs">
            ...
            <div className="flex flex-wrap items-center gap-3 pt-2">
              <button
                ...
                className="px-6 py-3 bg-[#0B1E38] hover:bg-[#152e52] disabled:opacity-60 text-white text-xs sm:text-sm font-semibold rounded-md shadow-xs transition-all active:scale-[0.98] cursor-pointer"
                id="review-report-problem-button"
              >
                {isSubmitting ? 'Registering with NMC...' : 'Report Problem'}
              </button>
